...
const ProfilLoggInn = () => {
    ...
    return (
        <View style={styles.profilLoggInnContainer}>
            <GradientScreen>
                <Text style={[styles.profilLoggInnInputLabel, { left: 96, top: 172 }]}>Brukernavn/e-post</Text>
                <View style={[styles.profilLoggInnInputGroup, { left: 96, top: 193.3 }]}>
                    <InputField
                        icon={Brukerikon}
                ...
                <Text style={[styles.profilLoggInnInputLabel, { left: 96, top: 252 }]}>Passord</Text>
                <View style={[styles.profilLoggInnInputGroup, { left: 96, top: 273.3 }]}>
                    <InputField
                        icon={Passordikon}
                        placeholder={"*********"}
                        secureTextEntry
                ...
                <TouchableOpacity>
                    <Text style={[styles.profilLoggInnForgotPassword, { left: 226, top: 315 }]}>Glemt Passord?</Text>
                </TouchableOpacity>
                <Button
                    text="Logg inn"
                    onPress={handleLogin}
                ...
                />
                <Text style={[styles.profilLoggInnItalicText, { left: 127, top: 443 }]}>Eller logg deg inn med</Text>
                <ThirdPartyIconRow
                ...
                />
                <Text style={[styles.profilLoggInnItalicText, { left: 184, top: 564 }]}>Ny her?</Text>
                <Button
                    text="Registrer deg"
                    onPress={() => {
                        console.log('Current Navigation State:', navigation.getState());
